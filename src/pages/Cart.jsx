      ...
      (<div className="flex md:flex-row flex-col gap-6 max-w-6xl mx-auto justify-between">
        <div className="">
        {
          ...
          <div className="w-full">
            ...
            className="text-white font-semibold px-10 py-3 text-xl bg-green-700 border-2 border-green-700 hover:bg-white hover:text-green-700 w-[95%] 
            mx-auto transition-colors duration-300 rounded-lg mt-4">Checkout Now</button>
          </div>
        </div>
      </div>)
    }
